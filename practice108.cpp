///////////////////////////////////////////////////////////////////
//Final Code Of Queue using Generic Approach with menu-driven
///////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    while(1)
    {
        ...
        cout<<"3 : Dsplay the element of the queue\n";
        cout<<"4 : Count the numbers of element from the queue\n";
        ...
        {
            case 1:
                cout<<"Enter the element that you want to inser :\n";
                cin>>Value;
                qobj->enqueue(Value);
